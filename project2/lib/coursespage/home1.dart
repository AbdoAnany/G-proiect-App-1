...
class HomeState extends State<Home1> {
  ...
  Widget build(BuildContext context) {
    ...
    List <Text> info = [
      Text('Abd Elrahman Anany',style: AppTheme.infoLabletitle,),
...
Widget homeListItem(HomeList homeList) {
  return Material(
    ...
    child: homeList.avilabe
        ...
        icon: homeList.icon,padding: EdgeInsets.all(5),
        label: Text(
          homeList.lable,
...
class HomeList {
  ...
  HomeList(
      {this.icon, this.lable = '', this.avilabe = true, this.index, this.move});
}
